...
#include "class_test_interfaces/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const class_test_interfaces::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<class_test_interfaces::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &class_test_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const class_test_interfaces::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<class_test_interfaces::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &class_test_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &class_test_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
