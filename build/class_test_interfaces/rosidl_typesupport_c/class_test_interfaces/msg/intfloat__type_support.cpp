...
static const _Intfloat_type_support_symbol_names_t _Intfloat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interfaces, msg, Intfloat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, class_test_interfaces, msg, Intfloat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, class_test_interfaces, msg, Intfloat)() {
  return &::class_test_interfaces::msg::rosidl_typesupport_c::Intfloat_message_type_support_handle;
}
