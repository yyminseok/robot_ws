...
#include "class_test_interfaces/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddThreeInts_Request__ros_msg_type = class_test_interfaces__srv__AddThreeInts_Request;
...
size_t get_serialized_size_class_test_interfaces__srv__AddThreeInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddThreeInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_class_test_interfaces__srv__AddThreeInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_class_test_interfaces
size_t max_serialized_size_class_test_interfaces__srv__AddThreeInts_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_class_test_interfaces__srv__AddThreeInts_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AddThreeInts_Request = {
  "class_test_interfaces::srv",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interfaces, srv, AddThreeInts_Request)() {
...
using _AddThreeInts_Response__ros_msg_type = class_test_interfaces__srv__AddThreeInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_class_test_interfaces
size_t get_serialized_size_class_test_interfaces__srv__AddThreeInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeInts_Response__ros_msg_type * ros_message = static_cast<const _AddThreeInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_class_test_interfaces__srv__AddThreeInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_class_test_interfaces
size_t max_serialized_size_class_test_interfaces__srv__AddThreeInts_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_class_test_interfaces__srv__AddThreeInts_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interfaces, srv, AddThreeInts_Response)() {
...
// already included above
// #include "class_test_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "class_test_interfaces/srv/add_three_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interfaces, srv, AddThreeInts)() {
