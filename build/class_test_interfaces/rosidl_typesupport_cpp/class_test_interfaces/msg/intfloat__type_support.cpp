...
static const _Intfloat_type_support_symbol_names_t _Intfloat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, class_test_interfaces, msg, Intfloat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, class_test_interfaces, msg, Intfloat)),
  }
};
...
{
  return &::class_test_interfaces::msg::rosidl_typesupport_cpp::Intfloat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, class_test_interfaces, msg, Intfloat)() {
  return get_message_type_support_handle<class_test_interfaces::msg::Intfloat>();
}
